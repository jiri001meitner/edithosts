...
##### Aktualizováno: Čt bře 1 03:18:06 CET 2018 ##################
: Expires=1
- -reklama.
- .com/bannery/
- .cz/BAN/
...
-d primewire.org /additional_content.php
...
+d shink.in /js/main.js
+d shink.in /js/wow.min.js
-d shink.in .js
